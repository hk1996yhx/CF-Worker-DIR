 ...
 */
const config = {
  title: "度娘",                 //write your website title
  subtitle: "aaaaaaaaa", //write your website subtitle
  logo_icon: "paper plane",   //(you can get more msg in:https://semantic-ui.com/elements/icon.html)
  ...
  sell_info:{
    domain:"377020945.xyz",
    price:500,                        //domain price
    mon_unit:"yen sign",              //monetary unit 
    contact:[                         //how to contact you
      {
        type:"qq",               //contact type ("weixin","qq","telegram plane","envelope" or "phone")
        content:"377020945@qq.com"
      }
    ]                        
  },
  lists: [                            //Url list
...
function renderIndex(){
  const footer = el('footer',[],el('div',['class="footer"'],'Powered by' + el('a',['class="ui label"','href="https://github.com/hk1996yhx/CF-Worker-DIR"','target="_blank"'],el('i',['class="github icon"'],"") + 'Cf-Worker-Dir') + ' &copy; Base on ' + el('a',['class="ui label"'],el('i',['class="balance scale icon"'],"") + 'MIT License')));
...
function renderHTML(index, seller) {
  ...
  function randomBackgroundImage() {
    ...
    const backgrounds = [
      'url(https://raw.githubusercontent.com/hk1996yhx/CF-Worker-DIR/master/top_img1.jpg)',
      'url(https://raw.githubusercontent.com/hk1996yhx/CF-Worker-DIR/master/top_img2.jpg)',
      'url(https://raw.githubusercontent.com/hk1996yhx/CF-Worker-DIR/master/top_img3.jpg)',
      'url(https://raw.githubusercontent.com/hk1996yhx/CF-Worker-DIR/master/top_img4.jpg)',
      'url(https://raw.githubusercontent.com/hk1996yhx/CF-Worker-DIR/master/top_img5.jpg)',
      'url(https://raw.githubusercontent.com/hk1996yhx/CF-Worker-DIR/master/top_img6.jpg)',
      'url(https://raw.githubusercontent.com/hk1996yhx/CF-Worker-DIR/master/top_img7.jpg)',
      'url(https://raw.githubusercontent.com/hk1996yhx/CF-Worker-DIR/master/top_img8.jpg)',
      'url(https://raw.githubusercontent.com/hk1996yhx/CF-Worker-DIR/master/top_img9.jpg)',
      'url(https://raw.githubusercontent.com/hk1996yhx/CF-Worker-DIR/master/top_img10.jpg)',
...
<link href="https://loader.377020945.workers.dev/style.css" type="text/css" rel="stylesheet">
<script src="https://cdn.jsdelivr.net/npm/semantic-ui-css@2.4.1/semantic.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/jquery@3.6/dist/jquery.min.js"></script>
<style> 
  #head {
    background: ${headbackground}; 
    height: 700px; /* 设置背景高度为100像素 */
  }
  h1 {
